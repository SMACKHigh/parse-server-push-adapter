...
var APNS = exports.APNS = function () {
  ...
  _createClass(APNS, [{
    ...
    value: function send(data, allDevices) {
      ...
      var deviceTokensPerAppIdentifier = {};
      ...
      allDevices.forEach(function (device) {
        ...
        deviceTokensPerAppIdentifier[appIdentifier] = deviceTokensPerAppIdentifier[appIdentifier] || [];
        if (deviceTokensPerAppIdentifier[appIdentifier].indexOf(device.deviceToken) < 0) {
    ...
    value: function _chooseProviders(appIdentifier) {
      ...
      var qualifiedProviders = this.providers.filter(function (provider) {
        return provider.topic.indexOf(appIdentifier) !== -1;
      });
